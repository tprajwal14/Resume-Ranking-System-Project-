...
# GOOGLE_CLIENT_ID = "265143759231-uadl5r7ct5n7kr89rh27b12naeoji9f5.apps.googleusercontent.com"
GOOGLE_CLIENT_ID = "877375027866-4v5ur2ecn4jf0jll92ic9oj1rtiv5n2f.apps.googleusercontent.com"
...
app.config['MONGO_URI']= 'mongodb+srv://admin:admin@cluster0.1t1gaqo.mongodb.net/ResumeRanking'
...
#                                     email = "romanshilpakar50@gmail.com"
        ...
        try:
            ...
            if file and allowedExtension(file.filename):
                ...
                if resume_workedAs is not None:
                    ...
                    print("testing...worked as :", resume_workedAs)
                else:
                    value_workedAs = None
                ...
                if resume_experience is not None:
                    print("testing...years as :", resume_experience)
